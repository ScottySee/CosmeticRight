<%@ Page Title="" Language="C#" MasterPageFile="~/PrintPage.master" AutoEventWireup="true" CodeFile="PrintOrders.aspx.cs" Inherits="PrintOrders" %>
                                                ...
                                                <asp:ListView ID="lvPrintOrders" runat="server">
                                                    <ItemTemplate>
                                                        <tr class="text-center">
                                                            ...
                                                            <td><%# Eval("Quantity") %></td>
                                                            <td class="text-right">Php<%# Eval("Price", "{0: #,##0.00}") %>
                                                            </td>
                                                            <td class="text-right">Php<%# Eval("Amount", "{0: #,##0.00}") %>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                    <EmptyDataTemplate>
