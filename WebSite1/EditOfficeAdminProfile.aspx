                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div style="color: red">*</div>
                                    <div class="form-group">
                                        <asp:TextBox runat="server" ID="street" Placeholder="Street" CssClass="form-control" onkeypress="lettersOnly(event); numbersOnly(event)" MaxLength="50" required autocomplete="off"></asp:TextBox>
                                    </div>
                                    <div class="card-title pull-left">
                                        Municipality
                                    </div>
                                    ...
                                    <div class="form-group">
                                     <%--  <asp:RequiredFieldValidator runat="server" ControlToValidate="landline" ErrorMessage="Required" CssClass="text-danger">
                                        ...
                                        <asp:RegularExpressionValidator ControlToValidate="landline" runat="server" ValidationExpression=""></asp:RegularExpressionValidator>\--%>                                         <asp:TextBox runat="server" ID="landline" Placeholder="Phone" CssClass="form-control" MaxLength="12" onkeypress="return numbersOnly(event)" autocomplete="off"></asp:TextBox>
                                    </div>
                            ...
                            <span class="pull-right">
                                    <asp:Button ID="btnUpdate" runat="server" class="btn btn-success"
                                        Text="Edit" OnClick="btnUpdate_Click" />
                                </span>
                        </div>
                    </div>
